...
namespace MediaWebsite.Server.Migrations
{
    ...
    [Migration("20260610210906_AddConnectionRequest")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MediaWebsite.Server.Data.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("MediaWebsite.Server.Data.UserConnection", b =>
                {
            ...
            modelBuilder.Entity("MediaWebsite.Server.Data.UserConnection", b =>
                {
                    b.HasOne("MediaWebsite.Server.Data.ApplicationUser", "ConnectedUser")
                        .WithMany("ConnectedBy")
                        .HasForeignKey("ConnectedUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MediaWebsite.Server.Data.ApplicationUser", "User")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("MediaWebsite.Server.Data.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
