        ...
        <div className={styles.layout}>
            <form className={`${styles.card} bg-surface rounded-2 shadow d-flex flex-column align-items-center`} onSubmit={handleSubmit}>
                ...
                <div style={{ width: "80%" }}>
                    ...
                    <input value={email} onChange={e => setEmail(e.target.value)} placeholder="Email or Username" aria-label="Email or Username" className="form-control mb-4" />
                    <p className="fs-6 mb-1 text-start">Password</p>
                    <input value={password} onChange={e => setPassword(e.target.value)} type="password" placeholder="Password" aria-label="Password" className="form-control mb-4" />
                </div>
                <button type="submit" className="btn btn-theme shadow-sm mb-3">Login</button>
